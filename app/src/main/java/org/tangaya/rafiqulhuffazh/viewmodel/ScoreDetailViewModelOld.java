...
public class ScoreDetailViewModelOld extends AndroidViewModel {
    ...
    public MutableLiveData<ArrayList<ScoreDetailViewModelOld>> arrayListMutableLiveData = new MutableLiveData<>();

    private ArrayList<ScoreDetailViewModelOld> arrayList;

    public ScoreDetailViewModelOld(@NonNull Application application, EvaluationOld evaluation) {
        super(application);
    ...
    public MutableLiveData<ArrayList<ScoreDetailViewModelOld>> getArrayListMutableLiveData() {
        ...
        for (int i = 0; i< evaluations.size(); i++) {
            ScoreDetailViewModelOld mViewModel = new ScoreDetailViewModelOld(getApplication(), evaluations.get(i));
